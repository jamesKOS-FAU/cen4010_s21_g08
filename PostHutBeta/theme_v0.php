    ...
    <body>
        ...
        <section class="jumbotron jumbotron-fluid bg-info text-white" id="Portfolio">
            <div class="container">
                ...
                <h5> <br> Today's theme is: <b>Cats</b></h5>
	   ...
	   <div class="card"> 
            ...
            <img src="./cat.jpg" alt="black cat" style="width:100%" height="auto" class = "center"> 
            <br> 
            <p><button class = "like_btn"> 
                 <span id = "icon"><i class ="far fa-thumbs-up"></i></span> 
                 <span id = "count">101</span> NICE! 
                </button> 
            </p> 
        </div>
<br>
<br>
        <div class="card"> 
            <div class="content"
	<?php
		$sql = "SELECT * FROM Posts ORDER BY ThemeID;";

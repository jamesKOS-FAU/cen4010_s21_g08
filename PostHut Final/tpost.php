...
<head>
    <title>Create a Themed Post</title>
	<meta charset="UTF-8">
...
<body>
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
		   ...
		   <a class="nav-item nav-link active" href="./post.php">Post!</a>
		   <a class="nav-item nav-link active" href="#">Themed Post!</a>
              </div> 
    
	</div>
		<form class="form-inline"> 
                    <p>Posting as: <b><?php echo htmlspecialchars($_SESSION["username"]); ?></b></p> 
                </form> 
    ...
    <div class="limiter">
		...
		<div class="wrap-login100" style="margin:auto;">
			...
			<form name=createpost action="tpostpost.php" method = "post" enctype="multipart/form-data" class="validate form">
			<span class="login100-form-title p-b-34 p-t-27">Create a Themed Post</span>

			<div class="form-group, wrap-input100 validate-input">
			
				<label for="ThemeID">Theme: <br>(ex. cats,dog,etc. Please do not add any unnecessary spaces or text)  </label>
				<input type="text" id="ThemeID" name="ThemeID" required maxlength=10><br><br>

    ...
    <div class="limiter">
	   ...
	   <div class="form-group <?php echo (!empty($username_err)) ? 'has-error' : ''; ?>, wrap-input100 validate-input" data-validate = "Enter username">
		...
		<span class="focus-input100" data-placeholder="&#xf191;"></span>
           ...
           <div class="form-group <?php echo (!empty($confirm_password_err)) ? 'has-error' : ''; ?>, wrap-input100 validate-input" data-validate="Confirm password"> 
 
                <input type="password" name="confirm_password" class="form-control, input100" value="<?php echo $confirm_password; ?>" required placeholder="Confirm Password" style="letter-spacing: 0.75px"> 
		<span class="focus-input100" data-placeholder="&#xf191;"></span> 
